...
class PerfTaskSet(TaskSet):
    ...
    def assign_address_to_cart(self):
        req_data = AssignAddressToCartRequest(userInfo=self.get_user_info(), appInfo=self.get_app_info(),
                                              deviceInfo=self.get_device_info(), addressId="1")
...
class AssignAddressToCart(User):
    tasks = [PerfTaskSet]

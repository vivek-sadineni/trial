...
from gateway.requests.CreateOrderRequest_pb2 import CreateOrderRequest
from gateway.responses.CreateOrderResponse_pb2 import CreateOrderResponse
...
class TesterClient:
    ...
    def create_order(self, request: CreateOrderRequest) -> CreateOrderResponse:
        with sonora.client.insecure_web_channel(
            ...
            stub.createOrder(request=request)
...
class PerfTaskSet(TaskSet):
    ...
    def create_order(self):
        req_data = CreateOrderRequest(userInfo=self.get_user_info(), appInfo=self.get_app_info(), deviceInfo=self.get_device_info(),
                                      campaignId="", stracker="", strackerValue="", walletAmount="")
        self.locust_request_handler("create_order", req_data)
